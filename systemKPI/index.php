        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <form align="left" action="#" method="post"
                    ...
                    <input align="center" class="btn btn-success" type="submit" value="Export file CSV."
                        name="ext_report_it" name="ext_report_it">
                                    ...
                                    <form action="" method="GET">
                                        <div id="myDropdown" class="dropdown-content ">
                                            <div style="text-align:left;">
                                                ...
                                                <br>
                                                <input type="checkbox" id="myCheck"
                                                    onclick="myFunction2()">ขอติดตั้งโปรแกรมเพิ่มเติม
                                                <br>
                                                ...
                                                <br>
                                                <input type="checkbox" id="myCheck"
                                                    onclick="myFunction2()">ส่งเครื่องพนักงานใหม่
                                                <br>
                                                <input type="checkbox" id="myCheck" onclick="myFunction2()">อื่น ๆ
                                                <br><input type="checkbox" id="myCheck"
                                                    onclick="myFunction2()">ส่งเครื่องพนักงานใหม่
                                                ...
                                                <button type="submit" class="btn btn-warning"
                                                    onclick="Checkingall()">ดูทั้งหมด </button>
